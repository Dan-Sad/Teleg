...
namespace Teleg
{
    class QuestionRUS : ILanguageQuestion
    {
        ...
        public string Lubricant { get; } = $"Выбери каким лубрикантом пользуешься или собираешься. Лубрикант влияет на материал игрушки, поэтому для более долгой работы и собственной безопасности стоит подобрать одно под другое.Плюшка* лубрикант добавит большей чувствительности, а ещё эффект кунилингуса от вакуумников с ним более выраженный. А здесь можешь прочесть нужную информацию по лубрикантам:{String.Format("https://t.me/who_if_not_hand/5")}";
        ...
        public string Wishes { get; } = "Таак, игрушка будет прилагаться к тебе и желательно, чтобы всё же она была с пользой. Так что выбирай себе её прямые функции, зачем она тебя и что она сделает для тебя";
    ...
    class ButtonRUS : ILanguageButton
    {
        ...
        public string CoupleClitor { get; } = "Дополнительная стимуляции клитора";
