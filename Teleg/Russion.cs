...
namespace Teleg
{
    ...
    class ButtonRUS : ILanguageButton
    {
        ...
        public string LubricantNoMatters { get; } = "Не считаю лубрикант важным";
        ...
        public string FetishPublicPlace { get; } = "Тайно в публичном месте";
        ...
        public string FetishSecretGame { get; } = "Пусть никто не знает что внутри";//
        ...
        public string FetishFillPlace { get; } = "Хочу прочувствовать местность";
